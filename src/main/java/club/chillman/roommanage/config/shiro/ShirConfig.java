...
import club.chillman.roommanage.config.jwt.JwtFilter;
...
public class ShirConfig {
    ...
    public ShiroFilterFactoryBean factory(DefaultWebSecurityManager securityManager) {
        ...
        //登陆相关api不需要被过滤器拦截
        filterRuleMap.put("/api/wx/login/**", "anon");
        filterRuleMap.put("/api/wx/bind/**", "anon");
        filterRuleMap.put("/api/wx/register/**", "anon");
